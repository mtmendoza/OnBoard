...
INSERT INTO `manager` VALUES (1501,2015001);
...
INSERT INTO `organization` VALUES (2015001,'La Salle Computer Society','p@ss');
...
CREATE TABLE `user` (
  ...
  CONSTRAINT `manager_id` FOREIGN KEY (`manager_id`) REFERENCES `manager` (`manager_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user` VALUES (11123456,'Juan','Dela Cruz','juandelacruz@gmail.com','Student',NULL,''),(11234567,'Derpina','Chualongkorn','derpinaxxx@yahoo.com','Student',1501,'');
...
-- Dump completed on 2015-03-18 21:52:41
